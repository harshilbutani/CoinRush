...
namespace StarterKit.UIKit
{
    ...
    public class CanvasHierarchyEditor
    {
        ...
        private static void Initialize()
        {
            ...
            IconON =
                       AssetDatabase.LoadAssetAtPath("Assets/Editor/UtilityImage/On.png", typeof(Texture2D)) as
                           Texture2D;
            IconOFF = AssetDatabase.LoadAssetAtPath("Assets/Editor/UtilityImage/Off.png",
